      ...
      return Scaffold(
        ...
        appBar: context.watch<RegistrationProvider>().isLoadingRegistration
            ...
            : AppBar(
                ...
                title: const Text('Shopper registration',
                    style:
                            ...
                            builder: (context) {
                              ...
                              return Container(
                                ...
                                child: SafeArea(
                                  ...
                                  color: Colors.white,
                                  child: Modal(scenario: 'help_signup_details'),
                                )),
                              );
                            });
                      },
                        ...
                        children: [
                          ...
                          Opacity(
                            ...
                            child: Row(
                              ...
                              children: [
                                Checkbox(
                                    activeColor: AppTheme().getSecondaryColor(),
                                    value: context
                                        .watch<RegistrationProvider>()
                                        .iTrulyProvided,
    ...
    switch (nature) {
      case 'personal_details':
        ...
        return data['name']!.isNotEmpty &&
            ...
            ? [
                Icon(Icons.check_circle, color: AppTheme().getPrimaryColor()),
                'Done'
              ]
            : data['name']!.isEmpty &&
