                ...
                child: context.watch<RegistrationProvider>().driverPhoto == null
                    ? showTakeProfilePicData(
                        ...
                        illustrationExamplePath:
                            'assets/Images/profilePicModel.png',
            ...
            child: SafeArea(
                child: context.watch<RegistrationProvider>().carPhoto == null
                    ? showTakeProfilePicData(
                        ...
                        instructions: generateInstructions(
                          stringRequirements: [
                            'Make sure that all the vehicle right or left side are visible with the Taxi number on it.',
                            'Make sure the photo is well fit, free of glare and in focus.',
                          ],
                        ),
            ...
            child: SafeArea(
                child: context.watch<RegistrationProvider>().licensePhoto ==
                    ...
                    ? showTakeProfilePicData(
                        context: context,
                        illustrationExamplePath:
                            'assets/Images/licenseTemplate.png',
            ...
            child: SafeArea(
                child: context.watch<RegistrationProvider>().bluepaperPhoto ==
                    ...
                    ? showTakeProfilePicData(
                        context: context,
                        illustrationExamplePath:
                            'assets/Images/bluePaperTemplate.png',
                        title: 'Blue paper',
                        descr1:
            ...
            child: SafeArea(
                child: context.watch<RegistrationProvider>().whitepaperPhoto ==
                    ...
                    ? showTakeProfilePicData(
                        context: context,
                        illustrationExamplePath:
                            'assets/Images/whitePaperTemplate.png',
                        title: 'White paper',
                        descr1:
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(color: AppTheme().getSecondaryColor()),
