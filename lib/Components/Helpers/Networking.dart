    ...
    try {
      ...
      if (response.statusCode == 200) //Got some results
      {
        ...
        if (context.toString().contains('no widget') == false) {
          if (responseGet['response'] == 'error_invalid_request') {
            //! error
        ...
        builder: (context) {
          return Container(
            ...
            child: SafeArea(
              ...
              color: Colors.white,
              child: Modal(scenario: 'error_going_online'),
            )),
          );
        }).whenComplete(() {
  ...
  Future getCoreDate({required BuildContext context}) async {
    ...
    Map<String, dynamic> bundleData = {
      ...
      'pushnotif_token': context.read<HomeProvider>().pushnotif_token == null
          ? false
          : json
              .encode(context.read<HomeProvider>().pushnotif_token)
              .toString(),
      'user_nature': 'driver',
    ...
    // log(context.read<HomeProvider>().onlineOfflineData.toString());
                    ...
                    return Container(
                      ...
                      child: SafeArea(
                          ...
                          child: Container(
                            width: MediaQuery.of(context).size.width,
                            color: Colors.white,
                            child: Modal(scenario: 'accepted_request'),
                          )),
                    );
                  })
          ...
          return Container(
            ...
            child: SafeArea(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                  child: Modal(scenario: 'unable_to_accept_request'),
                )),
          );
        }).whenComplete(() {
      context
          ...
          return Container(
            ...
            child: SafeArea(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                  child: Modal(scenario: 'unable_to_cancel_request'),
                )),
          );
        }).whenComplete(() {
      context
          ...
          return Container(
            ...
            child: SafeArea(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                  child: Modal(scenario: 'unable_to_confirmPickup_request'),
                )),
          );
        }).whenComplete(() {
      context
          ...
          return Container(
            ...
            child: SafeArea(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                  child: Modal(scenario: 'unable_to_decline_request'),
                )),
          );
        }).whenComplete(() {
      context
          ...
          return Container(
            ...
            child: SafeArea(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  color: Colors.white,
                  child: Modal(scenario: 'unable_to_confirmDropoff_request'),
                )),
          );
        }).whenComplete(() {
      context
...
//Confirm dropoff - DELIVERY
class ConfirmDropoffRequestNet_delivery {
  Future exec(
      {required BuildContext context, required String request_fp}) async {
    //Init the sound
    // Sound sound = Sound();
    ...
    Map<String, String> bundleData = {
      ...
      'requestType': context.read<HomeProvider>().selectedOption,
      'scope':
          'final', //! To know if this is the final drop off confirmation or not - final (last) or ignore anything else.
      'selectedPackageIndex':
          context.read<HomeProvider>().selectedDropoffPackageIndex.toString()
    };
        ...
        builder: (context) {
          ...
          return Container(
            ...
            child: SafeArea(
              ...
              width: MediaQuery.of(context).size.width,
              color: Colors.white,
              child: Modal(scenario: 'error_sending_otpCode'),
            )),
          );
        }).whenComplete(() {
      context
      ...
      if (response.statusCode == 200) //Got some results
      {
        ...
        if (responseGot['response'] == false) //Some random error happended
        {
          ...
          showWrongCodeEntered(context: context);
            ...
            .hasMatch(responseGot['response'].toString())) //Wrong OTP entered
        {
          showWrongCodeEntered(context: context);
        } else //True OTP code
        {
        ...
        builder: (context) {
          ...
          return Container(
            ...
            child: SafeArea(
              ...
              width: MediaQuery.of(context).size.width,
              color: Colors.white,
              child: Modal(scenario: 'error_checking_otpCode'),
            )),
          );
        }).whenComplete(() {
      context
        ...
        builder: (context) {
          ...
          return Container(
            ...
            child: SafeArea(
              ...
              width: MediaQuery.of(context).size.width,
              color: Colors.white,
              child: Modal(scenario: 'wrong_otp_code_entered'),
            )),
          );
        }).whenComplete(() {
      context
...
//Confirm done shopping
class ConfirmDoneShoppingRequestNet {
  Future exec(
      {required BuildContext context, required String request_fp}) async {
    //Init the sound
    // Sound sound = Sound();
