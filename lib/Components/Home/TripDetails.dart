                ...
                child: Row(
                  children: [
                    ButtonGeneralPurpose(
                        ...
                        flex: 1,
                        alignment: tripData['ride_basic_infos']
                                ['inRideToDestination']
                        ...
                        actuatorFunctionl: showFindPlaceloader
                            ...
                            : () {
                                ...
                                // print(tripData['origin_destination_infos']
                                //     ['destination_infos']);
                    ...
                    ButtonGeneralPurpose(
                      ...
                      fontSize: 19,
                      backgroundColor: tripData['ride_basic_infos']
                                  ['inRideToDestination'] ==
                              false
              ...
              Padding(
                ...
                child: Container(
                  child: ListTile(
                    ...
                    title: Text(RequestCardHelper()
                        .ucFirst(tripData['ride_basic_infos']['ride_style'])),
                    subtitle: Text(tripData['ride_basic_infos']['ride_style'] ==
                            'shared'
                        ? 'For this ride you are free to pickup anyone else on the road, since it\'s a shared ride.'
                        : 'For this ride you are only allowed to pickup this customer, since it\'s a private ride.'),
                  ),
                ),
              ),
              Divider(),
                    ...
                    Text(
                        context
                            ...
                            .getCleanPaymentMethod_nameAndImage(
                                payment: tripData['ride_basic_infos']
                                    ['payment_method'])['name']
                            .toString(),
