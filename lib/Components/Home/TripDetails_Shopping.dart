...
import 'package:shoppers_app/Components/Home/ShoppingList.dart';
...
class TripDetails_Shopping extends StatefulWidget {
  const TripDetails_Shopping({Key? key}) : super(key: key);

  @override
  _TripDetails_ShoppingState createState() => _TripDetails_ShoppingState();
}

class _TripDetails_ShoppingState extends State<TripDetails_Shopping> {
            ...
            children: [
              Container(
                ...
                child: ListTile(
                  ...
                  title: InkWell(
                    onTap: () => Navigator.pop(context),
                    child: const Text('Shopping details',
                        style: TextStyle(
                ...
                child: Row(
                  children: [
                    ButtonGeneralPurpose(
                        title: tripData['delivery_basic_infos']['didPickupCash']
                            ? 'Delivery'
                            : 'Pickup',
                        showIcon: true,
                    ...
                    ButtonGeneralPurpose(
                      title: tripData['delivery_basic_infos']
                              ...
                              false
                          ? 'Received money'
                          : tripData['delivery_basic_infos']['inRouteToShop'] &&
                                      ...
                                      .isTheShoppingListCompleted(
                                          packagesList:
                                              tripData['delivery_basic_infos']
                                                  ['shopping_list'])
                              ? () {
                                  ConfirmDoneShoppingRequest(context: context);
                                }
                              : context
                                          .watch<HomeProvider>()
                                          .isTheShoppingListCompleted(
                                        ...
                                        return Container(
                                          ...
                                          child: SafeArea(
                                              ...
                                              child: Container(
                                                ...
                                                child: Modal(
                                                    scenario:
                                                        'complete_shopping_blockedIncompletePurchases'),
                                              )),
                                        );
                                      })
                                  : () {
              ...
              Visibility(
                visible:
                    tripData['delivery_basic_infos']['didPickupCash'] == false,
                child: Column(
                  children: [
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: ListTile(
                            ...
                            title: Text('Cancel the shopping',
                                style: const TextStyle(
  ...
  void ConfirmDoneShoppingRequest({required BuildContext context}) {
    context.read<HomeProvider>().updateBlurredBackgroundState(
        shouldShow: true); //Show blurred background
    showModalBottomSheet(
            context: context,
              ...
              return Container(
                ...
                child: SafeArea(
                    ...
                    child: Container(
                      ...
                      color: Colors.white,
                      child: Modal(
                          scenario: 'shopping_confirmDoneShopping_request'),
                    )),
              );
            })
        .whenComplete(() => context
